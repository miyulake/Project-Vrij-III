...
public class ShakeController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (shakeTimer > 0f && shakeTarget != null)
        {
            ...
            var progress = 1f - (shakeTimer / shakeDuration); // 0 -> 1
            var currentMagnitude = Mathf.Lerp(shakeMagnitude, 0f, progress);
            ...
            if (shakeTimer <= 0f) shakeTarget.position = originalPosition;
        }
    }
